  ...
  return (
    <div className="min-h-screen bg-cream-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-6xl font-black text-tomato-500 mb-2" style={{ fontFamily: 'var(--font-display)' }}>
          404
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="px-6 py-3 bg-tomato-600 hover:bg-tomato-700 text-white font-semibold rounded-2xl transition-all shadow-lg shadow-tomato-100/50 hover:-translate-y-0.5 active:translate-y-0"
          >
            Retour à l&apos;accueil
          </Link>
          <Link
