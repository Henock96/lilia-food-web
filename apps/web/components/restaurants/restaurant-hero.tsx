    ...
    <div className="relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="-mt-12 relative bg-white rounded-2xl shadow-xl border border-zinc-100 p-5 sm:p-6"
        >
          <div className="flex flex-col sm:flex-row sm:items-start gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap mb-1">
                <h1 className="text-2xl font-bold text-zinc-900">{restaurant.nom}</h1>
                {restaurant.isOpen ? (
                  ...
                  <span className="flex items-center gap-1 px-2.5 py-1 bg-zinc-100 text-zinc-600 text-xs font-semibold rounded-full">
                ...
                {restaurant.averageRating && (
                  <div className="flex items-center gap-1.5">
                    ...
                    {restaurant.totalReviews && (
                      <span className="text-zinc-400">({restaurant.totalReviews} avis)</span>
                    )}
                  </div>
                )}
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2.5 border border-zinc-200 rounded-xl text-sm font-medium text-zinc-700 hover:bg-zinc-50 transition-colors flex-shrink-0"
            >
