...
const STATUS_STYLES: Record<string, string> = {
  ...
  ACCEPTEE:       'bg-lime-100 text-lime-700 dark:bg-lime-500/20 dark:text-lime-400',
  ...
  ECHEC_LIVRAISON: 'bg-orange-100 text-orange-800 dark:bg-orange-500/20 dark:text-orange-300',
};
